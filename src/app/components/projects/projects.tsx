...
const projectsFullStack = [
  {
    ...
    description:
      "Plataforma Full Stack para la gestión de salones de belleza con un sistema de e-commerce integrado. Incluye pagos con Mercado Pago, administración de empleados y ventas en tiempo real con Websockets. Si querés más detalles técnicos, consultame en la entrevista.",
    technologies:
      "Next.js, React, Redux Toolkit, MySQL, Tailwind CSS, Mercado Pago",
    ...
    demoVideo:
      "https://www.linkedin.com/feed/update/urn:li:activity:7238672562367414273/",
  },
  {
    title: "MakeUp - Plataforma de Belleza",
    description:
      "Plataforma full stack para el sector belleza con login seguro, panel administrativo y mensajería automatizada. Diseño responsive con Tailwind CSS. Si querés más detalles técnicos, consultame en la entrevista.",
    ...
    demoVideo:
      "https://www.linkedin.com/feed/update/urn:li:activity:7245273655893520386/",
  },
  ...
  // ───────── NUEVOS (Full/Pro) ─────────
  {
    ...
    description:
      "Colaboración en producto y calidad (E2E) para flujos web críticos. Implementación/ajustes de UI y pruebas automatizadas para releases confiables. Si querés más detalles técnicos, consultame en la entrevista.",
  ...
  },
  {
    ...
    description:
      "Desarrollo de nuevas secciones, componentes reutilizables y mejoras de performance/UX (skeletons, SEO). Si querés más detalles técnicos, consultame en la entrevista.",
...
const projects = [
  {
    ...
    description:
      "Aplicación web para ciclistas con UI moderna y animaciones fluidas. Si querés más detalles técnicos, consultame en la entrevista.",
  ...
  },
  {
    ...
    description:
      "App para gestión de contenido educativo con autenticación y diseño adaptable. Si querés más detalles técnicos, consultame en la entrevista.",
  ...
  // ───────── NUEVOS (Webs públicas) ─────────
  {
    ...
    description:
      "Página informativa con enfoque en claridad de contenidos y conversión. Si querés más detalles técnicos, consultame en la entrevista.",
  ...
  },
  {
    ...
    description:
      "Landing dinámica para programa de mentoría, pensada para velocidad percibida y SEO. Si querés más detalles técnicos, consultame en la entrevista.",
  ...
  },
  {
    ...
    description:
      "Sitio institucional en entorno de desarrollo con foco en estructura, accesibilidad y performance. Si querés más detalles técnicos, consultame en la entrevista.",
